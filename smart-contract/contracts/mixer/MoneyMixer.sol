...
contract MoneyMixer is IMoneyMixer {
  ...
  function recordSendTransaction(address account, uint256 index, uint256 e) external onlyProtocol {
  ...
  function recordSendSignature(address account, uint256 e, uint256 r) external onlyProtocol {
  ...
  function doValidityCheck() external view onlyProtocol {
    ...
    require(totalReceiveMoney == totalSendMoney, "Total send money not equal total receive money");
  }
